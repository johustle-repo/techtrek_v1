...
/**
* @see \App\Http\Controllers\Staff\BusinessController::index
 * @see app/Http/Controllers/Staff/BusinessController.php:13
 * @route '/staff/businesses'
 */
...
/**
* @see \App\Http\Controllers\Staff\BusinessController::create
 * @see app/Http/Controllers/Staff/BusinessController.php:20
 * @route '/staff/businesses/create'
 */
...
/**
* @see \App\Http\Controllers\Staff\BusinessController::store
 * @see app/Http/Controllers/Staff/BusinessController.php:25
 * @route '/staff/businesses'
 */
...
/**
* @see \App\Http\Controllers\Staff\BusinessController::show
 * @see app/Http/Controllers/Staff/BusinessController.php:0
 * @route '/staff/businesses/{business}'
 */
 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\Staff\BusinessController::edit
 * @see app/Http/Controllers/Staff/BusinessController.php:46
 * @route '/staff/businesses/{business}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/staff/businesses/{business}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 */
    ...
    edit.form = editForm
/**
* @see \App\Http\Controllers\Staff\BusinessController::update
 * @see app/Http/Controllers/Staff/BusinessController.php:55
 * @route '/staff/businesses/{business}'
 */
...
/**
* @see \App\Http\Controllers\Staff\BusinessController::destroy
 * @see app/Http/Controllers/Staff/BusinessController.php:80
 * @route '/staff/businesses/{business}'
 */
