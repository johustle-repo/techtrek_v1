...
export default function Index({ events }: { events: Event[] }) {
  ...
  return (
    <AppLayout breadcrumbs={[{ title: 'Events', href: '/admin/events' }]}>
      ...
      <div className="mx-auto w-full space-y-6 rounded-2xl bg-blue-50/40 p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Link href="/admin/events/create" className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-blue-600 px-5 text-sm font-semibold text-white shadow hover:bg-blue-700">
                ...
                {filtered.map((item) => (
                  <tr key={item.id} className="hover:bg-blue-50/40 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link href={`/admin/events/${item.id}/edit`} className="inline-flex items-center rounded-md border border-blue-200 bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700 hover:bg-blue-100 transition-colors">
                        Edit
                      </Link>
